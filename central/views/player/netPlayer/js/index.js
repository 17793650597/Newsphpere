...
////	    	CentralProxy.getNetPlayer(function(resp) {
//	    	CentralProxy.getNewsDongxi(param, function(resp) {
//	    		console.log(resp);
//		    	var netplayerArray = [];
...
//					$('.loading').hide();
//			    	var title = ModuleConfigHelper.getConfigByModuleName('ns.player.netPlayer').title;
...
//				$html.find('.item-title').text(row.source);
//				$html.find('.photo').attr("src", row.Photo)
//				$html.find('.item-title').text(row.title);
//				$html.find('.time').text(row.date);				
//				var imagesList = [];
//		        if(row.Photo){
//		        	imagesList.push(row.Photo);
//		        }
//				$html.click(function(){
//					DetailShow.show({
//			            container: $('body'),
