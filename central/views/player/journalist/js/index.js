...
//						appendVodSource(updateSetting);
		...
		var loadLiveSource = function() {
			...
			var url1 = ModuleConfigHelper.getConfigByModuleName('ns.player.journalist').url1 || '';
			var address = [{thumb: '../../../images/stations/jsgg.png', name:'记者视频连线', url:'http://124.165.218.198:8280/sxws/playlist.m3u8', isAudio:false}];
			address[0].url = url1
			//ＦＭ９３.７
			$(address).each(function(index, item){
				...
				div.find('a').click(function(){
					$('#cover').empty();
					if(item.name == "记者电话连线"){
						$('#cover').append('<img src="../../../images/phone.jpg">')
					}
